import os
from ticks import calc_due_ticks, is_due, ticks_add
...
def mqtt_poll(_temp, _set_temp):
    global mqtt_temp, mqtt_set_temp, mqtt_due
    if not mqtt_client:
        return
    try:
        ...
        if is_due(mqtt_due) or _set_temp != mqtt_set_temp:
